...
const App = () => {
			...
			<div className="flex flex-col h-screen bg-gray-50 max-w-lg mx-auto">
				...
				<div className="flex-1 overflow-auto px-6 pb-20">
					<div className="mb-8 mt-2">
						...
						<h1 className="text-3xl font-bold text-gray-800">Christine.</h1>
					</div>
						...
						<div className="bg-white rounded-xl shadow-md overflow-hidden border border-gray-100">
							<div className="h-40 bg-gradient-to-r from-amber-700 to-amber-500 flex items-center justify-center">
								<div className="text-center text-white">
									<p className="font-bold text-2xl">Roll Up To Win!</p>
									<p className="italic">MILLIONS of prizes to be won</p>
								</div>
							</div>
							<div className="p-4">
								...
								<p className="text-gray-600 text-sm mt-1">
									Play daily for more chances to win amazing prizes!
								</p>
	...
	if (isLoggedIn && currentPage !== "timsPlus") {
		return renderLoggedInHome();
	}
			...
			<div className="flex-1 overflow-auto px-6 pb-20">
				<div className="mb-8 mt-2">
					...
					<div className="flex flex-col mt-5 w-full space-y-3">
						...
						<button
							className="text-red-600 font-bold py-3 border border-red-600 rounded-full w-full"
